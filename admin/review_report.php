    ...
    <div class="admin-layout">
        <div class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="review_report.php" class="active"><i class="fas fa-file-alt"></i> review report</a></li>
            </ul>
        ...
        <div class="main-content">
            <div class="topbar">
                <div class="topbar-left">
                    ...
                    <h2 class="inner-shadow">review report</h2>
                </div>
            ...
            <div class="content-area">
                <div class="coming-soon">
                    <h2>🚀 Coming Soon!</h2>
                    <p>Fitur Review Report sedang dalam pengembangan.</p>
